...
import {
  ...
  proposalToolbarColorInputShellClasses,
  proposalToolbarColorInputTextClasses,
  proposalToolbarColorPreviewRingClasses,
  proposalToolbarPanelClasses,
  proposalToolbarPanelResetButtonClasses,
  proposalToolbarStyleTriggerDotRingClasses,
  proposalToolbarSwatchIdleBorderClasses,
  proposalToolbarSwatchRingOffsetClasses,
  proposalToolbarVariantPickerFrameClasses,
  proposalToolbarVariantPillClasses,
        ...
        >
          ...
          <span
            className={cn(
              ...
              proposalToolbarStyleTriggerDotRingClasses(appearance),
            )}
...
function StylePickerPanel({
  ...
  const frame = proposalToolbarVariantPickerFrameClasses(appearance);
  ...
  const resetButton = (
    <button
      ...
      className={cn(
        ...
        proposalToolbarPanelResetButtonClasses(appearance),
      )}
    >
      Reset to default
    </button>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        proposalToolbarVariantPillClasses(appearance, active),
      )}
      aria-pressed={active}
    >
      {label}
...
function ColorRow({
  ...
  const ringActive = proposalToolbarSwatchRingOffsetClasses(appearance);
  const swatchIdle = proposalToolbarSwatchIdleBorderClasses(appearance);
    ...
    <div>
      ...
      <div
        className={cn(
          ...
          proposalToolbarColorInputShellClasses(appearance),
        )}
      >
        <span
          className={cn(
            "h-6 w-6 shrink-0 rounded-full ring-1",
            proposalToolbarColorPreviewRingClasses(appearance),
          )}
        ...
        <input
          ...
          className={cn(
            ...
            proposalToolbarColorInputTextClasses(appearance),
          )}
