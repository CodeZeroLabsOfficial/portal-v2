...
export interface ProposalEngagementMetaProps {
  proposal: ProposalRecord;
}

/** View count + engagement time — shared by CRM cards and proposals hub. */
export function ProposalEngagementMeta({ proposal }: ProposalEngagementMetaProps) {
  return (
